...
export default function CoFounderCard({ person, delay = 0 }) {
  return (
    <Card
      delay={delay}
      className="rounded-xl border border-black/10 bg-white p-5 sm:p-7 lg:p-8"
    >
      <ProfilePhoto
        src={person.image}
        alt={`Portrait of ${person.name}, Co-Founder`}
        size="lg"
      />
